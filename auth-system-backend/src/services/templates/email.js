...
export const accountDeletedTemplate = (name) => {
  return `
    <!doctype html>
<html lang="en">
  <head>
            ...
            <tr>
              <td style="padding: 40px 40px 40px 40px">
                ...
                <p style="
                    ...
                    font-size: 16px;
                    line-height: 24px;
                  ">You will no longer be able to access your account or any related services.</p>
                  ...
                  <p style="
                    ...
                    font-size: 16px;
                    line-height: 24px;
                  ">Some limited information may be retained for a short period where required for legal, security, or administrative purposes.</p>
            ...
            <tr>
              <td style="padding: 40px 40px 40px 40px">
                ...
                <p
                  ...
                  "
                >
                  Use the code below to complete to reset your password. This
