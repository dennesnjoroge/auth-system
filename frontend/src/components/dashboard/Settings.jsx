...
function Security() {
  ...
  const { settings, logout, changePassword } = useAuth();
  ...
  async function handlePasswordChange(e) {
    ...
    try {
      ...
      changePassword(response.data.payload);
    } catch (error) {
      if (error.response) {
        toast.error(
  ...
  async function handleDelete(e) {
    ...
    if (confirmation !== "DELETE") {
      return toast.error("Confirmation word does not match. Try again");
    }
            ...
            >
              <div className="space-y-2">
                <label
                  ...
                  className="block text-sm font-medium text-gray-700"
                >
                  You are about to delete your account type{" "}
                  <strong>'DELETE'</strong> below to confirm. Your account will
